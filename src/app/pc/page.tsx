    ...
    <main className="bg-[#FDF4D3] p-8 flex gap-4 flex-col items-center justify-between">
      ...
      <div className="flex gap-4">
        <div className="rounded-md border border-neutral-400 p-4 flex flex-col gap-2">
          <div className="rounded-md bg-neutral-200 p-2 flex justify-center capitalize">
          ...
          <div className="flex justify-between rounded-md p-2 border border-[#D0C8B8]">
            <span>Level</span>
            <span>No markings</span>
          </div>
          <div className="rounded-md p-2 border border-[#D0C8B8]">Ability</div>
          <div className="rounded-md p-2 border border-[#D0C8B8]">Item</div>
        </div>
        <div className="justify-between rounded-md relative p-4 flex flex-col w-full border border-neutral-400">
          ...
          <div className="justify-self-end flex justify-between">
            <div className="cursor-pointer rounded-md flex items-center border border-neutral-900 p-4">
              Add Pokemon
            </div>
            <div className="cursor-pointer rounded-md flex items-center border border-neutral-900 p-4">
              Move
            ...
            <Link
              className="cursor-pointer rounded-md flex items-center border border-neutral-900 p-4"
              href="/"
            >
              Return
            </Link>
